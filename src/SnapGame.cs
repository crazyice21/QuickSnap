...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			SwinGame.LoadFontNamed ("GameFont", "Chunkfive.otf", 24);       //set the font type to Chunkfive
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.White, "GameFont", 0, 0);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.White, "GameFont", 0, 35);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White, "GameFont", 0, 70);
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 521, 153);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.White, "GameFont", 0, 30);
			}
